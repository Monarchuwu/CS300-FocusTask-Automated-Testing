...
WebUI.setText(findTestObject('Object Repository/Page_Sign Up - FocusTask/input_Email_email'), 'invalidEmail')
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Sign Up - FocusTask/div_Email is invalid_1'))
