...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/button_Low'))

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/div_Today_MuiBackdrop-root MuiBackdrop-invi_11231e'))
