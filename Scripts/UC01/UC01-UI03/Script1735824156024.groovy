...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Projects_r2'))

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/svg'))

WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r8'), '01/04/2025 11:24 PM')

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r8'))

WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r8'), '01/04/2025 11:59 PM')
