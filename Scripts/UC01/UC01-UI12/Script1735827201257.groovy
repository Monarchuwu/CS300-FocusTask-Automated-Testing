...
WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r10'), '01/04/2025 09:13 PM')
...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Low_PrivateSwitchBase-input css-j8yymo'))

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/span_Completed'))
