...
WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Projects_r4'), 'Testing Task')

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/svg'))

WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r12'), '01/04/2025 11:59 PM')
...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/div_Testing TaskHigh2359, 04-01-25'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Inbox - FocusTask/input_New Section_MuiInputBase-input MuiInp_bd1c6f'))
