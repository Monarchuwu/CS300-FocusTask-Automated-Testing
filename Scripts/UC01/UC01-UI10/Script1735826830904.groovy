...
WebUI.click(findTestObject('Object Repository/Page_Log In - FocusTask/div_Log inEmailEmailPasswordPasswordLog InD_32ce1a'))
...
WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r10'), '01/04/2025 09:08 PM')
...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/li_High'))
...
WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/button_2359, 04-01-25'))

WebUI.setText(findTestObject('Object Repository/Page_Inbox - FocusTask/input_Task Due Date_r1q'), '01/03/2025 11:59 PM')

WebUI.click(findTestObject('Object Repository/Page_Inbox - FocusTask/button_CONFIRM_1'))
